...
export default function Reviews() {
    return (
        <Card className='w-full rounded-xl bg-white shadow-lg drop-shadow-sm border-transparent  xl:w-full'>
            <CardContent className='px-1'>
                <CardHeader className='flex flex-row justify-between items-start text-body-header1'>
                    <div className='flex flex-row gap-1'>
                        <Avatar className='w-4 h-4' >
                            <AvatarImage src='https://github.com/shadcn.png'/>
                        </Avatar>
                        <div className='text-body-header1'>
                            <p className='text-[8px] xl:text-xs font-semibold truncate ... text-wrap'>James <span className=''>T</span></p>
                            <p className='font-light text-body-header1 text-[8px]'>5 months</p>
                        </div>
                    </div>

                    <div className='flex flex-col'>
                        <div className='font-semibold text-[8px] xl:text-xs capitalize self-end'>Ikeja, lagos</div>
                        <div className='h-4 '>
                            <Star name='rate2'  value={3} starCount={5} editing={false} />
                        </div>
                    </div>
                </CardHeader>
                ...
                <CardFooter className='flex flex-row-reverse justify-between items-center mt-2 md:mt-3 border-0 border-transparent pl-0 mx-0'>
